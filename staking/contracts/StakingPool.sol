...
contract StakingPool is IStakingPool, RewardsDistributor, ReentrancyGuard {
    ...
    function deposit(
        ...
        uint256 currentAllowance = stakingToken.allowance(
            msg.sender,
            address(this)
        );
        require(
        ...
        // Perform staking logic (assuming approval is sufficient)
    ...
    function notifyRewardAmount(
        uint256 reward
    ) external onlyRewardsDistributor updateReward(address(0)) {
